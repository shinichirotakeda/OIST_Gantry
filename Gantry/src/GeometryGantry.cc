...
G4LogicalVolume* GeometryGantry::Construct(std::string detname) {
 ...
 //======= CdTe-Double-sided Strip Ditectors  ======
  ...
  //FEC Holder
  G4double FECHolder_xSize = 165.0*mm;
  ...
  G4double Ceramic_Spacer_ySize = FECHolder_ySize;
  ...
  G4double FecKibanBody_xSize = Ceramic_Spacer_xSize;
  G4double FecKibanBody_ySize = Ceramic_Spacer_ySize;
  ...
  G4double FecKibanHole1_xPos = 29.55*mm;
  ...
  G4double DetectorModuleBody_xSize = FECHolder_xSize;
  G4double DetectorModuleBody_ySize = FECHolder_ySize;
  ...
  G4double CdTe_DSD_xPos = FecKibanHole1_xPos; //29.55*mm
  ...
  // Support materials
  // EndRing
  G4double EndRing_Phimin = 86.0*mm;
  G4double EndRing_Phimax = 240*mm;
  ...
  G4double ColdPlate1_Phimin = 86.0*mm;
  G4double ColdPlate1_Phimax = 204*mm;
  G4double ColdPlate1_zSize = 21.0*mm;
  ...
  */
  ...
  G4double Housing_body_Phimin = 254.0*mm;
  G4double Housing_body_Phimax = 262.0*mm;
  ...
  G4double Flange_org_Phimax = 306.0*mm;
  G4double Flange_org_zSize = 28.0*mm;
  ...
  G4double Flange_Hole_xPos = 0.0*mm;
  ...
  G4double Flange1_xPos = DetectorModule_xPos + FECHolder_xSize*0.5 + EndRing_zSize + 38.0*mm + Flange_org_zSize*0.5 ;
  ...
  // Pipe
  // Be Pipe
  G4double BePipe_Phimin = 74.0*mm;
  G4double BePipe_Phimax = 76.0*mm;
  ...
  // Al pipes
  G4double AlPipe1_Phimin = 74.0*mm;
  G4double AlPipe1_Phimax = 80.0*mm;
  G4double AlPipe1_zSize = (Flange1_xPos+Flange_org_zSize*0.5)-BePipe_zSize*0.5;
  ...
  G4double AlPipe2_Phimin = 74.0*mm;
  G4double AlPipe2_Phimax = 80.0*mm;
  G4double AlPipe2_zSize = - BePipe_zSize*0.5 - (Flange2_xPos-Flange_org_zSize*0.5);
  ...
  */
  ...
  G4double Dodai_Partsorg_xSize = Flange_org_Phimax*0.5 + 17.0*mm;
  G4double Dodai_Partsorg_ySize = 225.0*mm;
  G4double Dodai_Partsorg_zSize = Flange_org_zSize;
  ...
  G4double Dodai_Parts_Hole_Phimax = Flange_org_Phimax;
  G4double Dodai_Parts_Hole_zSize = Flange_org_zSize + margin;
  ...
  G4double Dodai_Parts1_xPos = Flange1_xPos;
  //Housing_body_xPos - Housing_body_zSize*0.5 + Dodai_Partsorg_zSize*0.5 ;
  G4double Dodai_Parts1_yPos = 0.0*mm;
  G4double Dodai_Parts1_zPos = Flange_Hole_xPos - Dodai_Partsorg_xSize*0.5;

  G4double Dodai_Parts2_xPos = Flange2_xPos;
    //Housing_body_xPos + Housing_body_zSize*0.5 - Dodai_Partsorg_zSize*0.5 ;
  ...
  G4double Ita_zPos = -170*mm - Ita_zSize*0.5;
  ...
  part1_Attributes->SetColor(0.7,0.4,0.1,0.25); 
