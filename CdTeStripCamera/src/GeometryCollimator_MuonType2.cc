...
G4LogicalVolume* GeometryCollimator_MuonType2::Construct(G4ThreeVector *pos) {
  ...
  G4double PinholeCone_Rmax2 = 0.7*mm; 
  ...
  G4ThreeVector p1(-7.14*mm,7.14*mm,0);
  G4ThreeVector p2(0,7.14*mm,0);
  G4ThreeVector p3(7.14*mm,7.14*mm,0);
  G4ThreeVector p4(-7.14*mm,0,0);
  G4ThreeVector p5(0,0,0);
  G4ThreeVector p6(7.14*mm,0,0);
  G4ThreeVector p7(-7.14*mm,-7.14*mm,0);
  G4ThreeVector p8(0,-7.14*mm,0);
  G4ThreeVector p9(7.14*mm,-7.14*mm,0);
